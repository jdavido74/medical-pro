...
export const countries = [
  ...
  { code: 'AT', name: 'Austria', flag: '🇦🇹', phone: '+43', digits: 10 },
  { code: 'BE', name: 'Bélgica', flag: '🇧🇪', phone: '+32', digits: 9 },
  { code: 'CH', name: 'Suiza', flag: '🇨🇭', phone: '+41', digits: 9 },
  { code: 'DE', name: 'Alemania', flag: '🇩🇪', phone: '+49', digits: 10 },
  { code: 'GB', name: 'Reino Unido', flag: '🇬🇧', phone: '+44', digits: 10 },
  { code: 'IE', name: 'Irlanda', flag: '🇮🇪', phone: '+353', digits: 9 },
  ...
  { code: 'NL', name: 'Países Bajos', flag: '🇳🇱', phone: '+31', digits: 9 },
  { code: 'PT', name: 'Portugal', flag: '🇵🇹', phone: '+351', digits: 9 },

  // — Northern Europe —
  { code: 'DK', name: 'Dinamarca', flag: '🇩🇰', phone: '+45', digits: 8 },
  { code: 'EE', name: 'Estonia', flag: '🇪🇪', phone: '+372', digits: 8 },
  { code: 'FI', name: 'Finlandia', flag: '🇫🇮', phone: '+358', digits: 9 },
  { code: 'IS', name: 'Islandia', flag: '🇮🇸', phone: '+354', digits: 7 },
  { code: 'LT', name: 'Lituania', flag: '🇱🇹', phone: '+370', digits: 8 },
  { code: 'LV', name: 'Letonia', flag: '🇱🇻', phone: '+371', digits: 8 },
  { code: 'NO', name: 'Noruega', flag: '🇳🇴', phone: '+47', digits: 8 },
  { code: 'SE', name: 'Suecia', flag: '🇸🇪', phone: '+46', digits: 9 },

  // — Central & Eastern Europe —
  { code: 'AL', name: 'Albania', flag: '🇦🇱', phone: '+355', digits: 9 },
  { code: 'BA', name: 'Bosnia y Herzegovina', flag: '🇧🇦', phone: '+387', digits: 8 },
  { code: 'BG', name: 'Bulgaria', flag: '🇧🇬', phone: '+359', digits: 9 },
  { code: 'BY', name: 'Bielorrusia', flag: '🇧🇾', phone: '+375', digits: 9 },
  { code: 'CZ', name: 'Chequia', flag: '🇨🇿', phone: '+420', digits: 9 },
  { code: 'GE', name: 'Georgia', flag: '🇬🇪', phone: '+995', digits: 9 },
  { code: 'HR', name: 'Croacia', flag: '🇭🇷', phone: '+385', digits: 9 },
  { code: 'HU', name: 'Hungría', flag: '🇭🇺', phone: '+36', digits: 9 },
  { code: 'MD', name: 'Moldova', flag: '🇲🇩', phone: '+373', digits: 8 },
  { code: 'ME', name: 'Montenegro', flag: '🇲🇪', phone: '+382', digits: 8 },
  { code: 'MK', name: 'Macedonia del Norte', flag: '🇲🇰', phone: '+389', digits: 8 },
  { code: 'PL', name: 'Polonia', flag: '🇵🇱', phone: '+48', digits: 9 },
  { code: 'RO', name: 'Rumanía', flag: '🇷🇴', phone: '+40', digits: 10 },
  { code: 'RS', name: 'Serbia', flag: '🇷🇸', phone: '+381', digits: 9 },
  { code: 'RU', name: 'Rusia', flag: '🇷🇺', phone: '+7', digits: 10 },
  { code: 'SI', name: 'Eslovenia', flag: '🇸🇮', phone: '+386', digits: 8 },
  { code: 'SK', name: 'Eslovaquia', flag: '🇸🇰', phone: '+421', digits: 9 },
  { code: 'UA', name: 'Ucrania', flag: '🇺🇦', phone: '+380', digits: 9 },
  { code: 'XK', name: 'Kosovo', flag: '🇽🇰', phone: '+383', digits: 8 },

  // — Southern Europe / Mediterranean —
  { code: 'CY', name: 'Chipre', flag: '🇨🇾', phone: '+357', digits: 8 },
  { code: 'GR', name: 'Grecia', flag: '🇬🇷', phone: '+30', digits: 10 },
  { code: 'MT', name: 'Malta', flag: '🇲🇹', phone: '+356', digits: 8 },
  { code: 'TR', name: 'Turquía', flag: '🇹🇷', phone: '+90', digits: 10 },

  // — North Africa / Maghreb —
  { code: 'DZ', name: 'Argelia', flag: '🇩🇿', phone: '+213', digits: 9 },
  { code: 'EG', name: 'Egipto', flag: '🇪🇬', phone: '+20', digits: 10 },
  { code: 'LY', name: 'Libia', flag: '🇱🇾', phone: '+218', digits: 9 },
  { code: 'MA', name: 'Marruecos', flag: '🇲🇦', phone: '+212', digits: 9 },
  { code: 'TN', name: 'Túnez', flag: '🇹🇳', phone: '+216', digits: 8 },

  // — Sub-Saharan Africa —
  { code: 'CI', name: 'Costa de Marfil', flag: '🇨🇮', phone: '+225', digits: 10 },
  { code: 'CM', name: 'Camerún', flag: '🇨🇲', phone: '+237', digits: 9 },
  { code: 'CD', name: 'RD Congo', flag: '🇨🇩', phone: '+243', digits: 9 },
  { code: 'GH', name: 'Ghana', flag: '🇬🇭', phone: '+233', digits: 9 },
  { code: 'GN', name: 'Guinea', flag: '🇬🇳', phone: '+224', digits: 9 },
  ...
  { code: 'SN', name: 'Senegal', flag: '🇸🇳', phone: '+221', digits: 9 },
  { code: 'ZA', name: 'Sudáfrica', flag: '🇿🇦', phone: '+27', digits: 9 },

  // — Middle East —
  { code: 'AE', name: 'Emiratos Árabes', flag: '🇦🇪', phone: '+971', digits: 9 },
  { code: 'IL', name: 'Israel', flag: '🇮🇱', phone: '+972', digits: 9 },
  { code: 'JO', name: 'Jordania', flag: '🇯🇴', phone: '+962', digits: 9 },
  { code: 'LB', name: 'Líbano', flag: '🇱🇧', phone: '+961', digits: 8 },
  { code: 'SA', name: 'Arabia Saudí', flag: '🇸🇦', phone: '+966', digits: 9 },

  // — Asia —
  { code: 'BD', name: 'Bangladesh', flag: '🇧🇩', phone: '+880', digits: 10 },
  { code: 'CN', name: 'China', flag: '🇨🇳', phone: '+86', digits: 11 },
  { code: 'ID', name: 'Indonesia', flag: '🇮🇩', phone: '+62', digits: 10 },
  { code: 'IN', name: 'India', flag: '🇮🇳', phone: '+91', digits: 10 },
  { code: 'JP', name: 'Japón', flag: '🇯🇵', phone: '+81', digits: 10 },
  { code: 'KR', name: 'Corea del Sur', flag: '🇰🇷', phone: '+82', digits: 10 },
  { code: 'MY', name: 'Malasia', flag: '🇲🇾', phone: '+60', digits: 10 },
  { code: 'PH', name: 'Filipinas', flag: '🇵🇭', phone: '+63', digits: 10 },
  { code: 'PK', name: 'Pakistán', flag: '🇵🇰', phone: '+92', digits: 10 },
  { code: 'SG', name: 'Singapur', flag: '🇸🇬', phone: '+65', digits: 8 },
  { code: 'TH', name: 'Tailandia', flag: '🇹🇭', phone: '+66', digits: 9 },
  { code: 'VN', name: 'Việt Nam', flag: '🇻🇳', phone: '+84', digits: 9 },

  // — North America —
  { code: 'CA', name: 'Canadá', flag: '🇨🇦', phone: '+1', digits: 10 },
  { code: 'MX', name: 'México', flag: '🇲🇽', phone: '+52', digits: 10 },
  { code: 'US', name: 'Estados Unidos', flag: '🇺🇸', phone: '+1', digits: 10 },
  ...
  { code: 'NZ', name: 'Nueva Zelanda', flag: '🇳🇿', phone: '+64', digits: 9 },
];
